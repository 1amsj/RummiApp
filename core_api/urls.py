...
urlpatterns = [
    ...
    *path_optionals_xor('admin/', ['<id:admin_id>', '<str:business_name>'], views.ManageAdmin.as_view(), name='manage_admin'),
    ...
    *path_optionals_xor('events_filters/', ['<id:event_id>', '<str:business_name>'], views.ManageEvents.as_view(), name='manage_events_filters'),
