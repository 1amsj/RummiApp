# Generated by Django 4.0.5 on 2022-08-29 18:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supercategory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subcategories', to='core_backend.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='events', to='core_backend.location')),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.AddField(
            model_name='booking',
            name='payer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bookings', to='core_backend.payer'),
        ),
        migrations.AddField(
            model_name='booking',
        ...
        migrations.AddField(
            model_name='booking',
            name='recipients',
            field=models.ManyToManyField(related_name='bookings', to='core_backend.recipient'),
        ),
        migrations.AddField(
            model_name='booking',
            name='requestor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='bookings', to='core_backend.requestor'),
        ),
        migrations.CreateModel(
