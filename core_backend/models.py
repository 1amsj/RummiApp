...
class Provider(models.Model):
    ...
    user = models.OneToOneField(User, models.CASCADE, 'as_provider', primary_key=True)


class Consumer(models.Model):
    """Who receives the service case"""
    user = models.OneToOneField(User, models.CASCADE, 'as_consumer', primary_key=True)


class Payer(models.Model):
    """Who pays the service bill"""
    user = models.OneToOneField(User, models.CASCADE, 'as_payer', primary_key=True)


class Agent(models.Model):
    """Who requests the service case for the Customer"""
    user = models.OneToOneField(User, models.CASCADE, 'as_agent', primary_key=True)
